...
def main():
    ...
    plot_geometry(
        straight,
        title="Straight Line Geometry",
        save_path=Path("straight_geometry.png"),
    )
    plot_geometry(
        noise, title="Noise Curve Geometry", save_path=Path("noise_geometry.png")
    )
    ...
    plot_loglog(
        straight_aggregated,
        title="Straight Line Log-Log Plot",
        save_path=Path("straight_loglog.png"),
    )
    ...
    plot_loglog(
        noise_aggregated,
        title="Noise Curve Log-Log Plot",
        save_path=Path("noise_loglog.png"),
    )
